<script>
    ...
    window.history.pushState("", "", "<?php echo base_url('profile')?>");

</script>
<aside class="aside-lg bg-light lter b-r" style="float: left;">
    <section class="">
...
<aside class="bg-white" style=" float: left; width: 67%;">
    <section class="" >
